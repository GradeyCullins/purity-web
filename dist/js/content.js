...
function filterImgTags(imgs) {
    return __awaiter(this, void 0, void 0, function () {
        var imgURIList, res, filterRes, filteredOutRes_1, filteredImgURLs, _i, filteredImgURLs_1, url, msg, passed_1, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (imgs.length === 0) {
