...
exports.health = exports.filterImages = void 0;
var purityAPIURL = 'http://localhost:8080';
function filterImages(imgURIs) {
    return __awaiter(this, void 0, void 0, function () {
        var url, opts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(purityAPIURL, "/filter/batch");
                    opts = {
                        method: 'post',
...
function health() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(purityAPIURL, "/health");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    res = _a.sent();
                    if (res.status !== 200) {
                        console.log("failed to reach backend with response code: ".concat(res.status));
                        return [2 /*return*/];
                    }
                    imgList = [].slice.call(document.getElementsByTagName('img'));
...
function filterImgTags(imgs) {
    return __awaiter(this, void 0, void 0, function () {
        var imgURIList, res, filterRes, filteredOutRes_1, filteredImgURLs, msg, passed_1, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (imgs.length === 0) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, api_1.filterImages)(imgURIList)];
                case 2:
                    res = _a.sent();
                    if (res.status !== 200) {
                ...
                case 3:
                    filterRes = _a.sent();
                    filteredOutRes_1 = filterRes.filter(function (res) { return !res.pass; });
                    filteredImgURLs = imgs
                        .filter(function (img) { return filteredOutRes_1.find(function (res) { return res.imgURI === img.src; }) !== undefined; })
                ...
                case 4:
                    _a.sent();
                    passed_1 = filterRes.filter(function (res) { return res.pass; });
                    imgs
                        .filter(function (img) { return passed_1.find(function (res) { return res.imgURI === img.src; }) !== undefined; })
